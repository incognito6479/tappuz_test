    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department_status', models.CharField(choices=[('active', 'Активный'), ('inactive', 'Неактивный')], default='active', max_length=255, verbose_name='Статус')),
                ('employee_number', models.IntegerField(verbose_name='Кол.во сотрудников')),
            ],
            options={
                'verbose_name': 'Отдел',
